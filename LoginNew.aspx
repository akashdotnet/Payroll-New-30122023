<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginNew.aspx.cs" Inherits="Samples.LoginNew" %>
...
<head>
    ...
    <!--[if lte IE 9]>
			<link rel="stylesheet" href="ace-master/assets/css/ace-part2.min.css" />
		<![endif]-->
                    ...
                    <div class="login-container">
                        <div class="center">
                            <h1>
                                ...
                                <span class="red">XYZ</span>
                                <span class="white" id="id-text2">Application</span>
                            </h1>
                            <h4 class="blue" id="id-company-text">&copy; Admin HR</h4>
                        </div>
                                            ...
                                            <fieldset>
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <asp:TextBox ID="tbUserName" runat="server" CssClass="form-control" placeholder="User name"></asp:TextBox>
                                                        <i class="ace-icon fa fa-user"></i>
                                                    </span>
                                                </label>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorUserName" runat="server"
                                                    ControlToValidate="tbUserName" ErrorMessage="*"
                                                ...
                                                <div class="clearfix">
                                                    ...
                                                    <asp:Button ID="btnSubmit" runat="server" Text="Sign in" OnClick="btnSubmit_Click" CssClass="width-35 pull-right btn btn-sm btn-primary" />
