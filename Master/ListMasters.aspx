         ...
         <asp:DropDownList ID="ddlBank" runat="server" Width="100%" CssClass="form-control custom-select">
                    ...
                    <div style="display: none">
                        ...
                        <div class="row">
                            <div class="col-lg-12  table-responsive">
                                <table id="myTableEmployement" class="table table-secondary order-listEmployement">
                                    <tr>
                    ...
                    <div style="display: none">
                        ...
                        <div class="row  table-responsive ">
                            ...
                            <table id="myTablefamily" class="table table-secondary order-listfamily">
                    ...
                    <div style="display: none">
                        ...
                        <div class="row table-responsive">
                            <table id='data_TableInfo' class="table table-secondary">
                                <tr>
           ...
           <asp:DropDownList ID="DropDownList27" runat="server" Width="100%" class="ddlShift form-control custom-select">
                        ...
                        <div class="tab-pane fade" id="attendance-report" role="tabpanel" aria-labelledby="custom-content-above-messages-tab">
                            ...
                            <div class="row">
                                <table class="table table-secondary" cellspacing="0">
                                    <tr>
                            ...
                            <div class="row">
                                <div class="col-md-12 table-responsive" style="overflow-x: auto;">
                                    <br />
                                    <table id="tableAttendance" class="table table-secondary" cellspacing="0">
                                    </table>
                                </div>
                            </div>
                        </div>
            ...
            var leaveRequest = function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        + '<table id="tableLeaveRequest" class="table table-secondary">                                            '
                        + '<thead>'
                        + '<tr>                                                                                                              '
            ...
            var onSalaryTemplate = function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        templateItemObject = [];
                        templateItemObject = data.dtEmpddress;
                        var html = '<div class="table-responsive"><table id="tableSalaryTemplate" class="table table-secondary"><thead><tr><th>Payroll Item</th><th>Payroll Type</th><th>Default Value</th><th>Value Type</th><th>Applicable On</th><th style="display:none">Active</th><th>Final Value</th></tr><thead><tbody>';
                        $('.salTemplate').html("");
                        $.each(templateItemObject, function (i, v) {
                            var actv = v.Acitve ? 'Yes' : 'No';
                            var vType = v.ISAmount ? "Rs." : "%";
