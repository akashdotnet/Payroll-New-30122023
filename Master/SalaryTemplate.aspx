...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    <form method="post" id="SalaryTemplateInfo" enctype="multipart/form-data" runat="server">
        ...
        <section class="content">
            <div class="tab-pane card-body" id="custom-content-above-profile" role="tabpanel" aria-labelledby="custom-content-above-profile-tab">
        ...
        var InitEmpSalaryTemplate = (function () {
            ...
            var initSalaryTemplate = function () {
                ...
                $.ajax({
                    ...
                    + '<table id="tableSalaryTemplate" class="table table-secondary dataTable">                                            '
                    + '<thead>'
                    + '<tr>                                                                                                              '
                    + '<td colspan="7">                                                                        '
            ...
            var _salayTemplateAddOrUpdate = function (operation, salaryTemplate) {
                $.ajax({
                    ...
                    success: function (response) {
                        CommonModule.showNotification(operation == 'Save' ? "Template Saved" : "Template updated", response.Html, 'success');
