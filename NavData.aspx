<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="NavData.aspx.cs" Inherits="Samples.NavData" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    <form id="maniMaster" runat="server">
                                ...
                                <ContentTemplate>
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td width="1%" align="left" class="FourPX" style="">
                                                            <asp:Button ID="btnCreateNew" runat="server" Text="Create New" OnClick="btnCreateNew_Click" class="btn btn-default"/>
                                                        </td>
                                                        ...
                                                        <td width="98%" colspan="4" align="center" valign="bottom" class="Questions11Px Bold">
                                                            <asp:UpdateProgress runat="server" ID="PageUpdateProgressReport" AssociatedUpdatePanelID="updReport"
                                                                DisplayAfter="1">
                                                                <ProgressTemplate>
                                                                    <img src="../Images/loading9.gif" alt="Processing, Please wait..." />
                                                                </ProgressTemplate>
                                                            </asp:UpdateProgress>
                                                        ...
                                                        <td>
                                                            <table width="10%">
                                                                <tr>
                                                                    <td>Search</td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtSearchOn" runat="server"></asp:TextBox></td>
                                                                    <td>
                                                                        <asp:Button ID="btnGo" runat="server" Text="GO" class="btn btn-default" /></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        ...
                                        <tr runat="server" id="trReportChart">
                                            <td width="100%" colspan="6" align="center" valign="top" runat="server" id="tdChart"></td>
                                        </tr>
                                        <!-------------------------------------------------------------------->
                                        <!--------- Report Footer -------------------------------------------->
                                    ...
                                    <asp:Button ID="btnRefresh" runat="server" Text="Refresh" Font-Bold="true" class="btn btn-default" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </div>
                </div>
